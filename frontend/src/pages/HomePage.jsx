...
// this is is home page with sugggested users disable version 3
// import { Box, Flex, Spinner } from "@chakra-ui/react";
// import { useEffect, useState } from "react";
// import useShowToast from "../hooks/useShowToast";
// import Post from "../components/Post";
...
// homepageversion 3 where theres in an update where users can immeadiatly see there posts when they have created an account 
	...
	return (
		<Flex gap="10" alignItems={"flex-start"}>
			<Box flex={70}>
				...
				{!loading && posts.length === 0 && (
					<Text>Follow users for the latest Brookhouse news.</Text>
				)}
