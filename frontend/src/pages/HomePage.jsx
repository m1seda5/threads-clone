...
const HomePage = () => {
  ...
  return (
    <Flex gap="10" alignItems={"flex-start"} className="homePageContainer"> {/* Apply background and overall container styles */}
      <Box flex={70}>
        {!loading && posts.length === 0 && (
          <h1 className="welcomeText">{t("Welcome to Pear! You have successfully created an account. Log in to see the latest Brookhouse news 🍐.")}</h1>  
        )}
